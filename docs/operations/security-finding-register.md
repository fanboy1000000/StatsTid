...
| SEC-004 | HR scoped to a sub-org can name a manager/vikar in a *sibling* sub-org of the same styrelse — outside their own subtree but inside the styrelse. | S91 secondary-principal lateral binding | ruled-revisit | Medium | A01 / EoP | known—should-be-revisited — **⚖ S131 reconciliation question (2026-08-19, owner ruling pending)**: QUAL-085 shows this residual's stated premise (the nested sub-org/styrelse model and `ValidateSameTreeAsync`/`ORG_AND_DESCENDANTS`) was retired by the S92–S95 flat-authority reform; the live check is exact-Organisation equality. Owner decides: CLOSE (hole's precondition gone) or RE-SCOPE the committed follow-up onto the flat model. | SECURITY.md "…secondary-principal binding (S91)" + `:126` (drifted — QUAL-085); S131 adjudication record | →#sec-004 |
