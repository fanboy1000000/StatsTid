...
real per-field schema deferred → SendAsync when the contract exists)** →
021 → 019 → 028/031/034/035 (remaining in the ROADMAP backlog → remediation sprint).
