...
| [ADR-016](decisions/ADR-016-temporal-period-handling.md) | Temporal period handling — PeriodPlanner + SegmentManifest + SnapshotContract (D5b reconciled S29 to add fourth pattern: export-time effective-date lookup for WTM) | approved | S20 (D5b reconciled S29) | Rule Engine, SharedKernel, Payroll, Infrastructure | segmentation, period, planner, manifest, ok-version, replay, audit |
