...
// section title (default hideTitle=false); OversightPage renders its own page
// <h3> and passes hideTitle to suppress this one so the title shows exactly once.
...
describe('ComplianceWarnings', () => {
  ...
  it('suppresses its internal <h3> when hideTitle is set (OversightPage contract)', () => {
