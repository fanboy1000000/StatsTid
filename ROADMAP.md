...
<!-- anchor-sprint: 64 -->
> **Current position (as of S64, 2026-06-05).** The phase sections below were authored far earlier; their phase→sprint numbers are **historical projections, retained as planning record, NOT current state**. What actually shipped:
