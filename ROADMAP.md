...
<!-- anchor-sprint: 62 -->
> **Current position (as of S62, 2026-06-03).** The phase sections below were authored far earlier; their phase→sprint numbers are **historical projections, retained as planning record, NOT current state**. What actually shipped:
