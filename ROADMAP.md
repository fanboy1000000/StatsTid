...
<!-- anchor-sprint: 63 -->
> **Current position (as of S63, 2026-06-04).** The phase sections below were authored far earlier; their phase→sprint numbers are **historical projections, retained as planning record, NOT current state**. What actually shipped:
