...
public class ReportingLineTests
{
    ...
    // S94 (TASK-9406): the S50 enforcement-toggle round-trip + TreeSettings model tests were
    // DELETED here — REQUIRED-mode enforcement is retired (ADR-035 OQ6). The `ExplicitFallbackConfirmation`
