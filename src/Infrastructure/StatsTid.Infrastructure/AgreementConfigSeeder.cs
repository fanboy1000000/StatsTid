        ...
        CancellationToken ct = default)
    {
        ...
        foreach (var (code, version) in AllConfigs)
        {
            ...
            var entity = new AgreementConfigEntity
            {
                ...
                DefaultCompensationModel = config.DefaultCompensationModel,
                EmployeeCompensationChoice = config.EmployeeCompensationChoice,
                MaxOvertimeHoursPerPeriod = config.MaxOvertimeHoursPerPeriod,
                OvertimeRequiresPreApproval = config.OvertimeRequiresPreApproval,
