...
public sealed class PeriodRejectedAuditMapper : IAuditProjectionMapper<PeriodRejected>
{
    public AuditProjectionRowData Map(PeriodRejected @event, AuditProjectionContext context)
    {
        var details = new
        {
