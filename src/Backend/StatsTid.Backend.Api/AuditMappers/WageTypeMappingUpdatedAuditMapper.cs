...
public sealed class WageTypeMappingUpdatedAuditMapper : IAuditProjectionMapper<WageTypeMappingUpdated>
{
    public AuditProjectionRowData Map(WageTypeMappingUpdated @event, AuditProjectionContext context)
    {
        var details = new
        {
