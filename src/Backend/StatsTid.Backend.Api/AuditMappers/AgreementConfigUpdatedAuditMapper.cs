...
public sealed class AgreementConfigUpdatedAuditMapper : IAuditProjectionMapper<AgreementConfigUpdated>
{
    public AuditProjectionRowData Map(AgreementConfigUpdated @event, AuditProjectionContext context)
    {
        var details = new
        {
