...
public sealed class WageTypeMappingCreatedAuditMapper : IAuditProjectionMapper<WageTypeMappingCreated>
{
    public AuditProjectionRowData Map(WageTypeMappingCreated @event, AuditProjectionContext context)
    {
        var details = new
        {
