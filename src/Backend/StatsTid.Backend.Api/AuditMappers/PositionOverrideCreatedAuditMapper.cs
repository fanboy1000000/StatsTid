...
public sealed class PositionOverrideCreatedAuditMapper : IAuditProjectionMapper<PositionOverrideCreated>
{
    public AuditProjectionRowData Map(PositionOverrideCreated @event, AuditProjectionContext context)
    {
        var details = new
        {
