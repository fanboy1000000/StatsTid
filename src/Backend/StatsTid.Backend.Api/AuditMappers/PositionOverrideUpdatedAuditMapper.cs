...
public sealed class PositionOverrideUpdatedAuditMapper : IAuditProjectionMapper<PositionOverrideUpdated>
{
    public AuditProjectionRowData Map(PositionOverrideUpdated @event, AuditProjectionContext context)
    {
        var details = new
        {
