...
public sealed class AgreementConfigArchivedAuditMapper : IAuditProjectionMapper<AgreementConfigArchived>
{
    public AuditProjectionRowData Map(AgreementConfigArchived @event, AuditProjectionContext context)
    {
        var details = new
        {
