...
public sealed class PositionOverrideConfigEntity
{
    ...
    /// endpoints continue to compile during the Phase 1 → Phase 2 transition. Phase 2
    /// repository updates (TASK-2504) will read the column from the DB and set this
    /// property explicitly. The DB column is <c>BIGINT NOT NULL DEFAULT 1</c> (TASK-2501
    /// migration <c>s25-d2-2-version</c>).
    /// </summary>
